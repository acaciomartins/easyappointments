...
$lang['manage_appointment_record_hint'] = 'Gerenciar todos os eventos dos profissionais e dos serviços disponíveis.';
$lang['select_filter_item_hint'] = 'Selecione o profissional ou o serviço e veja os eventos no calendário.';
...
$lang['manage_users_hint'] = 'Gerenciar os usuários de backend (administradores, profissionais, secretárias).';
$lang['settings_hint'] = 'Definir as configurações do sistema e do usuario.';
$lang['log_out_hint'] = 'Sair do Sistema.';
$lang['unavailable_periods_hint'] = 'Durante os periodos indisponíveis o profissionais não aceitar novos agendamentos.';
...
$lang['working_plan'] = 'Planos de trabalhos';
...
$lang['edit_working_plan_hint'] = 'Marque os dias e as horas a que a sua empresa aceita agendamentos. Assim será possível agendamentos em horário de atendimento, evitando que os clientes marquem agendamento fora do horário de atendimento. Este plano de trabalho será o padrão para cada novo registo de atendente, mas é possível mudar o plano de cada profissional separadamente editando o atendente. Depois disso, pode adicionar períodos de descanso.';
...
$lang['backend_section'] = 'Administrativo';
// $lang['you_need_to_login'] = 'Bem-Vindo! Precisa entrar para visualizar todo o conteúdo';
$lang['you_need_to_login'] = 'Bem-Vindo a área administrativa do eagenda! Você precisa entrar com seu Nome de usuário e Senha para administrar sua agenda.';
...
$lang['first_weekday_hint'] = 'Informe o primeiro dia da semana do calendário.';
...
$lang['cookie_notice'] = 'Politicas de cookies';
...
$lang['working_plan_exceptions_hint'] = 'Adicionar uma Exceção de Plano de Trabalho ao dia (fora do planejado).';
...
$lang['add_working_plan_exceptions_during_each_day'] = 'Adicionar uma Exceção de Plano de Trabalho ao dia (fora do planejado).';
// $lang['add_working_plan_exception'] = 'Add Working Plan Exception';
$lang['add_working_plan_exception'] = 'Adicionar uma Exceção';
...
$lang['require_phone_number_hint'] = 'Quando habilitado, os clientes e usuários precisam inserir um número de telefone do cliente para realizar o agendamento.';
// $lang['check_spam_folder'] = 'Please check your spam folder if the email does not arrive within a few minutes.';
$lang['check_spam_folder'] = 'Por favor check sua caixa de spam caso não receba o e-mail em alguns minutos.';
...
$lang['apply_to_all_providers'] = 'Aplicar alterações a todos os atendentes.';
...
$lang['display_any_provider_hint'] = 'Permite ao cliente fazer um agendamento sem escolher um Atendente.';
