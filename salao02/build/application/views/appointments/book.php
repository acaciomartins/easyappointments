...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= asset_assets_url('assets/ext/cookieconsent/cookieconsent.min.css') ?>">
    <link rel="stylesheet" type="text/css" href="<?= asset_assets_url('assets/css/frontend.css') ?>">
...
<script>
    var GlobalVariables = {
        ...
        baseAssetsUrl: <?= json_encode(config('base_assets_url')) ?>,
...
<script src="<?= asset_assets_url('assets/ext/cookieconsent/cookieconsent.min.js') ?>"></script>
...
<script src="<?= asset_assets_url('assets/js/frontend_book_api.js') ?>"></script>
<script src="<?= asset_assets_url('assets/js/frontend_book.js') ?>"></script>
