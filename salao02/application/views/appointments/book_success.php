...
<div id="main" class="container">
    <div class="row wrapper">
        <div id="success-frame" class="col-12 border my-auto frame-container">
            <div>
                <img id="success-icon" class="mt-0 mb-2" src="<?= base_assets_url('assets/img/success.png') ?>"/>
            </div>
...
<script src="<?= base_assets_url('assets/ext/jquery/jquery.min.js') ?>"></script>
<script src="<?= base_assets_url('assets/ext/bootstrap/js/bootstrap.bundle.min.js') ?>"></script>
<script src="<?= base_assets_url('assets/ext/datejs/date.min.js') ?>"></script>
...
<script src="<?= asset_assets_url('assets/js/frontend_book_success.js') ?>"></script>
