<script src="<?= asset_assets_url('assets/js/backend_services_helper.js') ?>"></script>
<script src="<?= asset_assets_url('assets/js/backend_categories_helper.js') ?>"></script>
<script src="<?= asset_assets_url('assets/js/backend_services.js') ?>"></script>
<script>
    var GlobalVariables = {
